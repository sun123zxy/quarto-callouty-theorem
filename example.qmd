...
format:
  html:
    filters: # apply the filter to HTML output only
      - callouty-theorem
  docx: default # other formats not infected
...
This example Quarto markdown file demonstrates the use of the `callouty-theorem` filter. For more information, see [the repository here](https://github.com/sun123zxy/quarto-callouty-theorem).
